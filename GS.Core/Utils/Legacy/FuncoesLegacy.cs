    ...
    public class FuncoesLegacy
    {
            ...
            using (SmtpClient smtp = new SmtpClient())
            {
                ...
                using (MailMessage msg = new MailMessage())
                {
                    ...
                    try
                    {
                        ...
                        {
                            FuncoesLegacy.CriarLabel(MostrarMsgAguarde, "Aguarde enviando E-mail...", "info");
                    ...
                    if (MostrarMsgAguarde != null)
                    {
                        FuncoesLegacy.RemoverLabel(MostrarMsgAguarde);
        ...
        public static string FormatarNumero(object Valor, string Formato = "C2")
        {
            ...
            try
            {
                ...
                string v = FuncoesLegacy.NormalizarNumero(Valor.ToString());
        ...
        public static void MesclarDataTable(DataTable dt1, DataTable dt2)
        {
            ...
            {
                FuncoesLegacy.MsgErro("Função: MesclarDataTable\r\n\r\nA quantidade de colunas dos DataTables não batem");
                return;
            }
            ...
            if (a > 0)
            {
                FuncoesLegacy.MsgErro("Função: MesclarDataTable\r\n\r\nO nome das colunas dos DataTables não conferem");
                return;
            }
